...
def analyze_BERT(content, temperature=0.0):
...
if __name__ == "__main__":
    ...
    BERT_analysis = analyze_BERT(content)
    ...
    bert_analysis_result = json.loads(BERT_analysis)
    print(json.dumps(bert_analysis_result, indent=4))
    ...
    insights_with_execution_id = {
        ...
        "metrics": insights,
        "insights":bert_analysis_result  # Add BERT analysis results under insights
    }
